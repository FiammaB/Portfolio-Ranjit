...
const screenVideos: ScreenVideo[] = [
    {
        ...
        position: { top: 16.4, left: 5.4, width: 14.6, height: 21.9 },
        transform: 'perspective(1500px) rotateZ(-6deg) rotateY(18deg) rotateX(3deg)',
        outerPoints: '18,7 56,8 82,8 92,13 95,24 95,78 91,89 78,96 26,97 14,91 10,80 10,24 14,12',
        innerPoints: '23,12 55,13 77,13 86,18 89,28 89,72 85,82 73,88 29,89 19,84 15,74 15,28 19,18',
